            ...
            <div ref={drawerContentRef} className="w-full">
              <div className="flex flex-col gap-3 rounded-t-[40px] rounded-b-[40px] border border-white/15 bg-card/45 p-5 pb-10 shadow-[0_8px_22px_-14px_rgba(0,0,0,0.22)] backdrop-blur-2xl lg:rounded-t-[44px] lg:rounded-b-[44px] lg:p-6 lg:pb-14">
                ...
                <button
                  ...
                  disabled={!track}
                  className="flex items-center justify-center gap-1.5 rounded-xl bg-white/5 px-3 py-2 text-xs font-medium text-red-400/90 hover:bg-red-500/15 hover:text-red-300 disabled:opacity-30"
                >
                ...
                <button
                  type="button"
                  onClick={signOut}
                  className="flex items-center justify-center gap-2 rounded-xl bg-white/5 px-3 py-2 text-xs font-medium text-foreground/90 hover:bg-white/10"
                >
